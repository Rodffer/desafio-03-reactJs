...
<br>
<p align="center" style="font-size: 29px"><b>Desafio 03 GoStack</b></p>
<p align="center">
  Desafio para treinar os conceitos de front-end com ReactJS. <br>
  <br>
...
<p>Nesse desafio, foi criado uma aplicação para treinar conceitos com ReactJS!</p>
<p>Essa aplicação permite: listar, adicionar e remover repositorios da API.</p>
<h2>Template da aplicação</h2>
<p>Foi utilizado o seguinte template para criar o projeto</p>
<p>O template está disponível na seguinte url: <strong><a href="https://github.com/Rocketseat/gostack-template-conceitos-reactjs">Acessar Template</a></strong></p>
<p>O desafio da Rocketseat está disponível na seguinte url: <strong><a href="https://github.com/Rocketseat/bootcamp-gostack-desafios/tree/master/desafio-conceitos-reactjs">Acessar Desafio Rocketseat</a></strong></p>
<hr>
